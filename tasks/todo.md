...
- [ ] **Английские числительные не согласованы** (Н-04). «1 users», «Import 3
  student», «1 modules» — счёт подставляется в строку, у которой одна форма.
  Видно на первом экране групп. Просит `Intl.PluralRules` и по две формы
  ключа; локалей шесть, у славянских форм три. Косметика, но её видит каждый
  новый администратор.
- [ ] **Панель учителя показывает пустую школу** (Н-10). Учитель видит
  онбординг «0/3» и «MY COURSES 0», хотя списком курсов школа не пуста.
  Прежде чем чинить, надо решить: панель учителя показывает *его* работу или
  школу целиком.
- [ ] **Учитель не может собрать состав группы** (Н-16). Подбор учеников
  ходит в `/admin/users`, тот отвечает 403 — справочник людей admin-only.
  Нужен источник учеников, доступный учителю, и решение, кого именно учителю
  положено видеть: свою группу, свои курсы или всю школу.
