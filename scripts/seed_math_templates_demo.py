"""Populate (or create) "Exercise Types Demo" course with TWO example
math_interactive exercises per template type, so the methodist / new
user opening the demo course can see every template rendered with two
distinct realistic puzzles (different difficulty / parameter shape).
...
TEMPLATES: list[tuple[str, str, str, dict]] = [
    ...
    (
        ...
        "Place A, B, C so they form the given triangle.",
        {
            "target_points": [
                {"x": 0, "y": 4, "label": "A"},
                {"x": -3, "y": -2, "label": "B"},
    ...
    (
        ...
        "Make 10 = 4 + ? + ? using twos and threes.",
        {
            "left_fixed": [10],
            "right_fixed": [4],
            "available_terms": [
    ...
    (
        ...
        "Which values are roots of x² - 5x + 6 = 0?",
        {
    ...
    (
        "scatter_plot",
        "Scatter Plot #1 — positive correlation, line of best fit",
    ...
    (
        ...
        "Complete the 3×4 frequency table.",
        {
    ...
    (
        ...
        "Drag each expression into linear / quadratic / cubic.",
        {
            "categories": [
