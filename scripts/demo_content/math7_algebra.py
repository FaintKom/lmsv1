            ...
            "lessons": [
                ...
                },
                {
                    ...
                    "text_md": (
                        ...
                        ":::tip Sanity check\n"
                        "After solving $2x + 3 = 11$ you got $x = 4$. Substitute: "
                        "$2(4) + 3 = 11$. ✓ If the substitution doesn't equal the original "
                        "right-hand side, you slipped a sign somewhere.\n"
                        ":::"
                    ),
                    "exercises": [
                        {
                ...
                },
                {
                    ...
                    "text_md": (
                        ...
                        ":::warning Watch out for negatives\n"
                        "$-2(x - 3) = -2x + 6$ — the **minus sign distributes too**. "
                        "Forgetting this is the #1 source of algebra mistakes.\n"
                        ":::"
                    ),
                    "exercises": [
                        {
