...
- [x] T045 tsc чистый, 542 юнит-теста, 79 бэкенд-тестов, 22 сквозных против собранного образа QA — зелёные. CI и E2E на PR зелёные.
- [x] T046 Пройден. Нашёл три вещи, которых не показали тесты: ложное предупреждение о слиянии, контраст меток против фона вместо подложки, и заголовок вкладки в гонке с гидратацией.
- [x] T047 PR #427, красные состояния перечислены в теле.
