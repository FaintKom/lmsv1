...
<!-- Vendored from github.com/wshobson/agents (MIT, ~38k stars) on 2026-07-17. See ./LICENSE.
     WRITTEN FOR NEXT.JS 14+. This repo is on Next.js 16 — core Server Component / streaming
     concepts hold, but VERIFY caching and fetch specifics against the installed version
     first (Next changed fetch caching defaults after 14). For THIS repo's gates (six-locale
     i18n ratchet, refresh dedup, no-white-on-yellow), use `grasslms-frontend`. -->
