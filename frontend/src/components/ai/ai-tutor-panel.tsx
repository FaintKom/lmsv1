...
export function AiTutorPanel({ context }: AiTutorPanelProps) {
 ...
 className="absolute -top-2 -right-2 z-[99] flex h-5 w-5 items-center justify-center rounded-pill bg-ink-700/80 text-white opacity-0 transition-opacity group-hover:opacity-100 hover:bg-danger"
 ...
 className={`flex h-14 w-14 items-center justify-center rounded-pill bg-gradient-to-br from-emerald-500 to-green-600 text-white shadow-lg shadow-green-500/30 transition-all hover:shadow-xl hover:shadow-green-500/40 ${
 ...
 return (
 <div className="fixed bottom-20 right-2 left-2 z-[98] flex max-h-[75vh] flex-col overflow-hidden rounded-lg border border-border-strong/80 bg-paper-2 shadow-2xl shadow-black/10 md:bottom-4 md:left-auto md:right-6 md:h-[540px] md:w-[380px] md:max-h-none">
 {/* Header */}
 <div className="flex items-center justify-between border-b border-border-strong/60 bg-gradient-to-r from-emerald-500 to-green-600 px-4 py-3 ">
 ...
 className="rounded-lg p-1.5 text-white/70 hover:bg-paper-2/20 hover:text-white"
 title={t("ai.clear")}
 >
 ...
 <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-gradient-to-br from-emerald-100 to-green-100 mb-3">
 ...
 <div className="px-4 py-1 text-center text-xs text-warning-fg ">
