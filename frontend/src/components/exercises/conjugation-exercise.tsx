...
export default function ConjugationExercise({ config, onSubmit }: Props) {
 ...
 onClick={handleCheck}
 disabled={!allFilled}
 className="w-full rounded-lg bg-primary px-6 py-3.5 text-base font-semibold text-white shadow-md transition duration-200 hover:bg-primary-hover hover:shadow-lg active:scale-[0.98] disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:shadow-md"
 >
 Check Answers
 </button>
 )}
