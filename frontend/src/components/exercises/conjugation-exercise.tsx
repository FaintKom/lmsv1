...
export default function ConjugationExercise({ config, onSubmit }: Props) {
 ...
 disabled={submitted}
 className={`w-full rounded-lg px-4 py-2.5 text-sm font-medium transition duration-200 outline-none
 ${
 ...
 onClick={handleCheck}
 disabled={!allFilled}
 className="w-full rounded-lg bg-primary px-6 py-3.5 text-base font-semibold text-primary-fg shadow-md transition duration-200 hover:bg-primary-hover hover:shadow-lg active:scale-[0.98] disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:shadow-md"
 >
 Check Answers
 </button>
 )}
