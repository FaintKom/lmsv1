...
export default function WebEditorExercise({
 ...
 className="flex items-center gap-2 rounded-lg bg-primary px-5 py-2.5 text-sm font-semibold text-primary-fg shadow-sm hover:bg-primary-hover disabled:opacity-50 transition-colors"
 >
