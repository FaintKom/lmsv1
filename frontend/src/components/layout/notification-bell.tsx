...
export function NotificationBell() {
 ...
 {unread > 0 && (
 <span className="absolute -right-0.5 -top-0.5 flex h-4 min-w-4 items-center justify-center rounded-pill bg-danger px-1 text-[10px] font-bold text-ink-900" aria-hidden="true">
 {unread > 99 ? "99+" : unread}
 </span>
 )}
 </button>
