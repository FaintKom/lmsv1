...
export default function DesmosCalculator({ open, onToggle }: DesmosCalculatorProps) {
 ...
 <button
 onClick={onToggle}
 className="fixed bottom-20 right-4 z-50 flex h-12 w-12 items-center justify-center rounded-pill bg-primary text-primary-fg shadow-lg transition-transform hover:scale-110 hover:bg-primary-hover"
