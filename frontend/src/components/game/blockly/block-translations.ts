...
const BLOCK_TRANSLATIONS: Record<string, BlockTranslations> = {
 en: {
 move_up: { label: "up", tooltip: "Face up and move one step" },
 move_down: { label: "down", tooltip: "Face down and move one step" },
 move_left: { label: "left", tooltip: "Face left and move one step" },
 move_right: { label: "right", tooltip: "Face right and move one step" },
 move_forward: { label: "forward", tooltip: "Move one step forward" },
 turn_left: { label: "turn left", tooltip: "Turn left 90°" },
 turn_right: { label: "turn right", tooltip: "Turn right 90°" },
 ...
 gap_ahead: { label: "gap ahead?", tooltip: "Is the square ahead lower down?" },
 ...
 ru: {
 move_up: { label: "вверх", tooltip: "Повернуться вверх и сделать шаг" },
 move_down: { label: "вниз", tooltip: "Повернуться вниз и сделать шаг" },
 move_left: { label: "влево", tooltip: "Повернуться влево и сделать шаг" },
 move_right: { label: "вправо", tooltip: "Повернуться вправо и сделать шаг" },
 move_forward: { label: "вперёд", tooltip: "Двигаться на одну клетку вперёд" },
 turn_left: { label: "повернуть влево", tooltip: "Повернуть налево на 90°" },
 turn_right: { label: "повернуть вправо", tooltip: "Повернуть направо на 90°" },
 ...
 gap_ahead: { label: "обрыв впереди?", tooltip: "Клетка впереди ниже?" },
 ...
 es: {
 move_up: { label: "arriba", tooltip: "Girar hacia arriba y avanzar un paso" },
 move_down: { label: "abajo", tooltip: "Girar hacia abajo y avanzar un paso" },
 move_left: { label: "izquierda", tooltip: "Girar a la izquierda y avanzar un paso" },
 move_right: { label: "derecha", tooltip: "Girar a la derecha y avanzar un paso" },
 move_forward: { label: "adelante", tooltip: "Avanzar una casilla hacia adelante" },
 turn_left: { label: "girar izquierda", tooltip: "Girar a la izquierda 90°" },
 turn_right: { label: "girar derecha", tooltip: "Girar a la derecha 90°" },
 ...
 gap_ahead: { label: "¿hueco delante?", tooltip: "¿La casilla de delante está más abajo?" },
 ...
 tr: {
 move_up: { label: "yukarı", tooltip: "Yukarı dön ve bir adım at" },
 move_down: { label: "aşağı", tooltip: "Aşağı dön ve bir adım at" },
 move_left: { label: "sol", tooltip: "Sola dön ve bir adım at" },
 move_right: { label: "sağ", tooltip: "Sağa dön ve bir adım at" },
 move_forward: { label: "ileri", tooltip: "Bir kare ileri git" },
 turn_left: { label: "sola dön", tooltip: "Sola 90° dön" },
 turn_right: { label: "sağa dön", tooltip: "Sağa 90° dön" },
 ...
 gap_ahead: { label: "önde boşluk?", tooltip: "Öndeki kare daha alçakta mı?" },
