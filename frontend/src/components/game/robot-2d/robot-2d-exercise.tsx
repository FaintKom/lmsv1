...
`;
 ...
 <div>
 <span className="text-sm font-bold text-primary ">{t("game.levelComplete")}</span>
 <span className="ml-2 text-xs text-text-subtle">{stepsUsed} {t("game.steps")} · {blockCount} {t("game.blocks")}</span>
 </div>
 </div>
 ...
 {failed && !completed && (
 <div className="flex items-center gap-3">
 <span className="text-sm text-danger-fg ">{failed}</span>
