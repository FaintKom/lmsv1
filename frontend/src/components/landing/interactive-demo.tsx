...
const MonacoEditor = dynamic(() => import("@monaco-editor/react"), {
 ssr: false,
 loading: () => (
 <div className="flex h-[200px] items-center justify-center bg-[#1e1e1e] rounded-lg text-sm text-text-subtle">
...
function SATDemo() {
 ...
 {selected !== null && (
 <div className="mt-4 rounded-lg border border-primary-soft bg-success-soft px-4 py-3 text-sm text-success-fg ">
...
function WebDemo() {
 ...
 <div className="grid grid-cols-1 md:grid-cols-2 gap-0 overflow-hidden rounded-lg border border-border-strong ">
 <div className="border-b md:border-b-0 md:border-r border-border-strong ">
 <MonacoEditor
 height="220px"
 language="html"
 value={code}
