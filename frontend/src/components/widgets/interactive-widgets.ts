    ...
    (function(){
      ...
      function render(){
        ...
        for(var k in vars){
          ...
          html+='<button onclick="delete window._vars_[\''+k+'\'];window._rerender_()" style="position:absolute;top:-6px;right:-6px;width:20px;height:20px;border-radius:50%;border:none;background:#ff7a5c;color:#fff;font-size:12px;cursor:pointer;line-height:20px">x</button>';
          html+='</div>';
        }
...
<div id="ifelse-widget" style="font-family:'Segoe UI',system-ui,sans-serif;max-width:480px;margin:0 auto;padding:20px;background:linear-gradient(135deg,#1e1e2e,#2d2b55);border-radius:16px;box-shadow:0 8px 32px rgba(0,0,0,.3);color:#e0e0e0">
  ...
  <div style="text-align:center;margin-bottom:12px">
    ...
    <div style="font-family:monospace;font-size:13px;color:#9aa39d;margin-top:4px">Condition: <strong style="color:#ffd84d">if x &gt; 50</strong></div>
  </div>
  <svg id="if-svg" viewBox="0 0 300 260" style="width:100%;max-width:300px;display:block;margin:0 auto">
    ...
    <!-- Diamond -->
    <polygon id="if-diamond" points="150,65 220,100 150,135 80,100" fill="#2a2a4a" stroke="#ffd84d" stroke-width="2"/>
    <text x="150" y="105" text-anchor="middle" fill="#ffd84d" font-size="12" font-family="monospace">x &gt; 50?</text>
    <!-- True branch -->
    ...
    <text x="240" y="92" fill="#3fb04b" font-size="11" font-family="monospace">True</text>
    <rect id="if-true-box" x="210" y="172" width="100" height="36" rx="10" fill="#2a2a4a" stroke="#3fb04b" stroke-width="2"/>
    <text x="260" y="195" text-anchor="middle" fill="#3fb04b" font-size="12" font-family="monospace">print("big")</text>
    <!-- False branch -->
    ...
    <text x="55" y="92" fill="#ff7a5c" font-size="11" font-family="monospace">False</text>
    <rect id="if-false-box" x="-10" y="172" width="100" height="36" rx="10" fill="#2a2a4a" stroke="#ff7a5c" stroke-width="2"/>
    <text x="40" y="195" text-anchor="middle" fill="#ff7a5c" font-size="12" font-family="monospace">print("small")</text>
    <!-- Merge -->
  ...
  <script>
    function updateIfElse(){
      ...
      document.getElementById('if-result').innerHTML=isTrue
        ?'<span style="color:#3fb04b">Output: "big"</span>'
        :'<span style="color:#ff7a5c">Output: "small"</span>';
    }
    updateIfElse();
  </script>
</div>`;
...
<div id="loop-widget" style="font-family:'Segoe UI',system-ui,sans-serif;max-width:480px;margin:0 auto;padding:20px;background:linear-gradient(135deg,#1e1e2e,#2d2b55);border-radius:16px;box-shadow:0 8px 32px rgba(0,0,0,.3);color:#e0e0e0">
  ...
  <div style="font-family:monospace;font-size:14px;background:#1a1a2e;padding:12px;border-radius:10px;margin-bottom:12px">
    <span style="color:#c084fc">for</span> i <span style="color:#c084fc">in</span> <span style="color:#ffd84d">range(<span id="loop-count">5</span>)</span>:<br/>
    &nbsp;&nbsp;print(i)
  </div>
    ...
    (function(){
      ...
      window.startLoop=function(){
        ...
        timer=setInterval(function(){
          ...
          if(i>0){var prev=document.getElementById('lb'+(i-1));if(prev){prev.style.background='#2a2a4a';prev.style.borderColor='#3fb04b';prev.style.color='#3fb04b'}}
          ...
          i++;
          if(i>=n)setTimeout(function(){var last=document.getElementById('lb'+(n-1));if(last){last.style.background='#2a2a4a';last.style.borderColor='#3fb04b';last.style.color='#3fb04b'}},speed/2);
        },speed);
      };
    })();
  </script>
...
<div id="list-widget" style="font-family:'Segoe UI',system-ui,sans-serif;max-width:500px;margin:0 auto;padding:20px;background:linear-gradient(135deg,#1e1e2e,#2d2b55);border-radius:16px;box-shadow:0 8px 32px rgba(0,0,0,.3);color:#e0e0e0">
  ...
  <div id="list-display" style="display:flex;gap:6px;flex-wrap:wrap;min-height:50px;padding:12px;background:#1a1a2e;border-radius:10px;margin-bottom:12px;align-items:center">
    <span style="color:#9aa39d;font-family:monospace;font-size:13px">my_list = [</span>
    <span id="list-items"></span>
    <span style="color:#9aa39d;font-family:monospace;font-size:13px">]</span>
  </div>
  <div style="display:flex;gap:8px;flex-wrap:wrap;margin-bottom:10px">
    ...
    <button onclick="listOp('append')" style="padding:8px 14px;border:none;border-radius:10px;background:#3fb04b;color:#fff;font-weight:600;cursor:pointer;font-size:13px">.append()</button>
    <button onclick="listOp('pop')" style="padding:8px 14px;border:none;border-radius:10px;background:#ff7a5c;color:#fff;font-weight:600;cursor:pointer;font-size:13px">.pop()</button>
    ...
    <button onclick="listOp('sort')" style="padding:8px 14px;border:none;border-radius:10px;background:#f5b800;color:#fff;font-weight:600;cursor:pointer;font-size:13px">.sort()</button>
  ...
  <div id="list-log" style="font-family:monospace;font-size:12px;color:#9aa39d;max-height:60px;overflow-y:auto"></div>
  <script>
    (function(){
      var arr=[3,1,4,1,5];
      var colors=['#f472b6','#a78bfa','#60a5fa','#34d399','#ffd84d','#fb923c','#f87171','#2dd4bf'];
      function render(){
        var html='';
...
<div id="dict-widget" style="font-family:'Segoe UI',system-ui,sans-serif;max-width:500px;margin:0 auto;padding:20px;background:linear-gradient(135deg,#1e1e2e,#2d2b55);border-radius:16px;box-shadow:0 8px 32px rgba(0,0,0,.3);color:#e0e0e0">
  ...
  <div style="display:flex;gap:8px;margin-bottom:14px;flex-wrap:wrap">
    <input id="dk" placeholder="key" style="flex:1;min-width:80px;padding:8px 12px;border:2px solid #4c4f82;border-radius:10px;background:#1a1a2e;color:#ffd84d;font-family:monospace;font-size:14px;outline:none" />
    <span style="color:#9aa39d;line-height:38px">:</span>
    ...
    <button onclick="dictAdd()" style="padding:8px 16px;border:none;border-radius:10px;background:#3fb04b;color:#fff;font-weight:600;cursor:pointer;font-size:13px">Add</button>
  </div>
  <div style="font-family:monospace;font-size:13px;color:#9aa39d;margin-bottom:6px">my_dict = {</div>
  <div id="dict-pairs" style="display:flex;flex-direction:column;gap:8px;padding:0 12px;min-height:40px"></div>
  <div style="font-family:monospace;font-size:13px;color:#9aa39d;margin-top:6px">}</div>
  <div id="dict-lookup" style="margin-top:14px;display:flex;gap:8px;align-items:center;flex-wrap:wrap">
    ...
    <input id="dl" placeholder="key" style="width:80px;padding:6px 10px;border:2px solid #4c4f82;border-radius:8px;background:#1a1a2e;color:#ffd84d;font-family:monospace;font-size:13px;outline:none" />
    ...
    (function(){
      ...
      function render(){
        ...
        for(var k in d){
          ...
          html+='<span style="padding:6px 12px;background:#ffd84d20;border:1.5px solid #ffd84d;border-radius:8px;color:#ffd84d;font-family:monospace;font-size:14px">"'+k+'"</span>';
          ...
          html+='<button onclick="dictDel(\''+k+'\')" style="width:22px;height:22px;border-radius:50%;border:none;background:#ff7a5c;color:#fff;font-size:11px;cursor:pointer">x</button>';
          html+='</div>';
        }
      ...
      window.dictGet=function(){
        ...
        else{el.style.color='#ff7a5c';el.textContent='KeyError: "'+k+'"'}
      };
      render();
    })();
  </script>
...
<div id="slope-widget" style="font-family:'Segoe UI',system-ui,sans-serif;max-width:480px;margin:0 auto;padding:20px;background:linear-gradient(135deg,#0a1a10,#1a2a1f);border-radius:16px;box-shadow:0 8px 32px rgba(0,0,0,.3);color:#e0e0e0">
  ...
  <div style="display:flex;gap:16px;margin-bottom:12px;flex-wrap:wrap;font-family:monospace;font-size:13px">
    <div>Point A: (<input id="s-x1" type="number" value="1" style="width:40px;padding:4px;border:1px solid #4d5a51;border-radius:6px;background:#0a1a10;color:#ffd84d;text-align:center;font-family:monospace" onchange="drawSlope()">,<input id="s-y1" type="number" value="2" style="width:40px;padding:4px;border:1px solid #4d5a51;border-radius:6px;background:#0a1a10;color:#ffd84d;text-align:center;font-family:monospace" onchange="drawSlope()">)</div>
    <div>Point B: (<input id="s-x2" type="number" value="5" style="width:40px;padding:4px;border:1px solid #4d5a51;border-radius:6px;background:#0a1a10;color:#22d3ee;text-align:center;font-family:monospace" onchange="drawSlope()">,<input id="s-y2" type="number" value="6" style="width:40px;padding:4px;border:1px solid #4d5a51;border-radius:6px;background:#0a1a10;color:#22d3ee;text-align:center;font-family:monospace" onchange="drawSlope()">)</div>
  </div>
  <canvas id="slope-cv" width="400" height="300" style="width:100%;border-radius:10px;background:#0a1a10;cursor:crosshair"></canvas>
  <div id="slope-info" style="text-align:center;font-family:monospace;font-size:15px;margin-top:10px;padding:10px;background:#1a2a1f;border-radius:10px"></div>
  <script>
    (function(){
      ...
      window.drawSlope=function(){
        ...
        // Axes
        ctx.strokeStyle='#4d5a51';ctx.lineWidth=1.5;ctx.beginPath();ctx.moveTo(0,oy);ctx.lineTo(W,oy);ctx.stroke();ctx.beginPath();ctx.moveTo(ox,0);ctx.lineTo(ox,H);ctx.stroke();
        var px1=ox+x1*scale,py1=oy-y1*scale,px2=ox+x2*scale,py2=oy-y2*scale;
        // Rise/Run
        var rise=y2-y1,run=x2-x1;
        if(run!==0){
          ctx.setLineDash([5,5]);ctx.strokeStyle='#ff7a5c88';ctx.lineWidth=2;
          ctx.beginPath();ctx.moveTo(px1,py1);ctx.lineTo(px2,py1);ctx.stroke();// run
          ctx.strokeStyle='#3fb04b88';
          ctx.beginPath();ctx.moveTo(px2,py1);ctx.lineTo(px2,py2);ctx.stroke();// rise
          ctx.setLineDash([]);
          ctx.fillStyle='#ff7a5c';ctx.font='bold 12px monospace';ctx.fillText('run='+run,(px1+px2)/2,py1+15);
          ctx.fillStyle='#3fb04b';ctx.fillText('rise='+rise,px2+5,(py1+py2)/2);
        }
        // Line extended
        if(run!==0){
        ...
        // Points
        ctx.fillStyle='#ffd84d';ctx.beginPath();ctx.arc(px1,py1,7,0,Math.PI*2);ctx.fill();
        ctx.fillStyle='#22d3ee';ctx.beginPath();ctx.arc(px2,py2,7,0,Math.PI*2);ctx.fill();
        // Labels
        ctx.fillStyle='#ffd84d';ctx.font='bold 12px monospace';ctx.fillText('A('+x1+','+y1+')',px1+10,py1-8);
        ctx.fillStyle='#22d3ee';ctx.fillText('B('+x2+','+y2+')',px2+10,py2-8);
        // Info
        var info='';
        if(run===0)info='<span style="color:#ff7a5c">Slope is undefined (vertical line)</span>';
...
<div id="quad-widget" style="font-family:'Segoe UI',system-ui,sans-serif;max-width:480px;margin:0 auto;padding:20px;background:linear-gradient(135deg,#0a1a10,#1a2a1f);border-radius:16px;box-shadow:0 8px 32px rgba(0,0,0,.3);color:#e0e0e0">
  ...
  <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:8px;margin-bottom:12px;font-size:13px">
    <div style="text-align:center"><label>a = <span id="qa-v">1</span></label><br/><input id="qa" type="range" min="-3" max="3" step="0.5" value="1" oninput="drawQuad()" style="width:100%;accent-color:#ff7a5c"/></div>
    <div style="text-align:center"><label>b = <span id="qb-v">0</span></label><br/><input id="qb" type="range" min="-5" max="5" step="0.5" value="0" oninput="drawQuad()" style="width:100%;accent-color:#3fb04b"/></div>
  ...
  <canvas id="quad-cv" width="400" height="300" style="width:100%;border-radius:10px;background:#0a1a10"></canvas>
  <div id="quad-info" style="text-align:center;font-family:monospace;font-size:13px;margin-top:8px;padding:8px;background:#1a2a1f;border-radius:10px"></div>
  <script>
    (function(){
      ...
      window.drawQuad=function(){
        ...
        if(a!==0){
          ...
          ctx.fillStyle='#ffd84d';ctx.beginPath();ctx.arc(vpx,vpy,6,0,Math.PI*2);ctx.fill();
          ctx.fillStyle='#ffd84d';ctx.font='bold 11px monospace';ctx.fillText('vertex('+vx.toFixed(1)+','+vy.toFixed(1)+')',vpx+8,vpy-8);
          // Axis of symmetry
          ctx.setLineDash([4,4]);ctx.strokeStyle='#ffd84d66';ctx.lineWidth=1;ctx.beginPath();ctx.moveTo(vpx,0);ctx.lineTo(vpx,H);ctx.stroke();ctx.setLineDash([]);
        }
        // Equation text
        var eq='y = '+a+'x² '+(b>=0?'+ ':'')+b+'x '+(c>=0?'+ ':'')+c;
        document.getElementById('quad-info').innerHTML='<span style="color:#f472b6">'+eq+'</span>'+(a!==0?' &nbsp; vertex: <span style="color:#ffd84d">('+(-b/(2*a)).toFixed(1)+', '+(a*(-b/(2*a))*(-b/(2*a))+b*(-b/(2*a))+c).toFixed(1)+')</span>':'');
      };
      drawQuad();
    })();
  </script>
...
<div id="sys-widget" style="font-family:'Segoe UI',system-ui,sans-serif;max-width:480px;margin:0 auto;padding:20px;background:linear-gradient(135deg,#0a1a10,#1a2a1f);border-radius:16px;box-shadow:0 8px 32px rgba(0,0,0,.3);color:#e0e0e0">
  ...
  <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;margin-bottom:12px;font-size:12px;font-family:monospace">
    <div style="background:#0a1a10;padding:10px;border-radius:10px;border:1.5px solid #ff7a5c">
      <div style="color:#ff7a5c;margin-bottom:6px">Line 1: y = m1*x + b1</div>
      m1=<span id="m1v">1</span> <input id="m1" type="range" min="-3" max="3" step="0.25" value="1" oninput="drawSys()" style="width:80%;accent-color:#ff7a5c"/><br/>
      b1=<span id="b1v">0</span> <input id="b1" type="range" min="-5" max="5" step="0.5" value="0" oninput="drawSys()" style="width:80%;accent-color:#ff7a5c"/>
    </div>
    <div style="background:#0a1a10;padding:10px;border-radius:10px;border:1.5px solid #3b82f6">
  ...
  <canvas id="sys-cv" width="400" height="300" style="width:100%;border-radius:10px;background:#0a1a10"></canvas>
  <div id="sys-info" style="text-align:center;font-family:monospace;font-size:13px;margin-top:8px;padding:8px;background:#1a2a1f;border-radius:10px"></div>
  <script>
    (function(){
      ...
      window.drawSys=function(){
        ...
        drawLine(m1,b1,'#ff7a5c');drawLine(m2,b2,'#3b82f6');
        var info='';
        if(m1===m2){info=b1===b2?'<span style="color:#ffd84d">Infinite solutions (same line)</span>':'<span style="color:#9aa39d">No solution (parallel lines)</span>'}
        else{
          var ix=(b2-b1)/(m1-m2),iy=m1*ix+b1;
          var px=ox+ix*sc,py=oy-iy*sc;
          ctx.fillStyle='#3fb04b';ctx.beginPath();ctx.arc(px,py,7,0,Math.PI*2);ctx.fill();
          ctx.strokeStyle='#3fb04b';ctx.lineWidth=2;ctx.beginPath();ctx.arc(px,py,14,0,Math.PI*2);ctx.stroke();
          ctx.fillStyle='#3fb04b';ctx.font='bold 12px monospace';ctx.fillText('('+ix.toFixed(1)+','+iy.toFixed(1)+')',px+12,py-10);
          info='Solution: <span style="color:#3fb04b">('+ix.toFixed(2)+', '+iy.toFixed(2)+')</span>';
        }
...
<div id="pyth-widget" style="font-family:'Segoe UI',system-ui,sans-serif;max-width:480px;margin:0 auto;padding:20px;background:linear-gradient(135deg,#0a1a10,#1a2a1f);border-radius:16px;box-shadow:0 8px 32px rgba(0,0,0,.3);color:#e0e0e0">
  ...
  <div style="display:flex;gap:16px;margin-bottom:12px;font-size:13px;flex-wrap:wrap">
    <div>a = <input id="pa" type="range" min="1" max="8" value="3" oninput="drawPyth()" style="width:80px;accent-color:#ff7a5c"/> <span id="pa-v" style="color:#ff7a5c;font-family:monospace">3</span></div>
  ...
  <canvas id="pyth-cv" width="400" height="340" style="width:100%;border-radius:10px;background:#0a1a10"></canvas>
  <div id="pyth-info" style="text-align:center;font-family:monospace;font-size:15px;margin-top:10px;padding:10px;background:#1a2a1f;border-radius:10px"></div>
  <script>
    (function(){
      ...
      window.drawPyth=function(){
        ...
        // Right angle marker
        var s=10;ctx.strokeStyle='#ffd84d';ctx.lineWidth=1.5;ctx.beginPath();ctx.moveTo(Ax+s,Ay);ctx.lineTo(Ax+s,Ay-s);ctx.lineTo(Ax,Ay-s);ctx.stroke();
        // Side a (vertical)
        ctx.fillStyle='#ff7a5c66';ctx.fillRect(Cx-a*sc,Cy,a*sc,a*sc);ctx.strokeStyle='#ff7a5c';ctx.lineWidth=1;ctx.strokeRect(Cx-a*sc,Cy,a*sc,a*sc);
        ctx.fillStyle='#ff7a5c';ctx.font='bold 14px monospace';ctx.fillText('a\u00B2='+a*a,Cx-a*sc+4,Cy+a*sc/2+5);
        // Side b (horizontal)
        ...
        // Side labels
        ctx.fillStyle='#ff7a5c';ctx.font='bold 15px monospace';ctx.fillText('a='+a,Ax-30,(Ay+Cy)/2+5);
        ctx.fillStyle='#3b82f6';ctx.fillText('b='+b,(Ax+Bx)/2-12,By+18);
        ctx.fillStyle='#3fb04b';ctx.fillText('c='+c.toFixed(2),(Cx+Bx)/2+10,(Cy+By)/2-8);
        // Info
        document.getElementById('pyth-info').innerHTML=
          '<span style="color:#ff7a5c">'+a+'\u00B2</span> + <span style="color:#3b82f6">'+b+'\u00B2</span> = <span style="color:#ff7a5c">'+a*a+'</span> + <span style="color:#3b82f6">'+b*b+'</span> = <span style="color:#3fb04b">'+(a*a+b*b)+'</span><br/>c = \u221A'+(a*a+b*b)+' = <strong style="color:#3fb04b">'+c.toFixed(4)+'</strong>';
      };
      drawPyth();
    })();
  </script>
...
<div id="uc-widget" style="font-family:'Segoe UI',system-ui,sans-serif;max-width:480px;margin:0 auto;padding:20px;background:linear-gradient(135deg,#0a1a10,#1a2a1f);border-radius:16px;box-shadow:0 8px 32px rgba(0,0,0,.3);color:#e0e0e0">
  <h3 style="margin:0 0 12px;font-size:18px;color:#38bdf8">Unit Circle</h3>
  <div style="text-align:center;margin-bottom:8px">
    <label style="font-size:13px">\u03B8 = <span id="uc-deg" style="color:#ffd84d;font-family:monospace">45</span>\u00B0 (<span id="uc-rad" style="color:#9aa39d;font-family:monospace">0.79</span> rad)</label><br/>
    <input id="uc-angle" type="range" min="0" max="360" value="45" oninput="drawUC()" style="width:80%;accent-color:#7c3aed;margin-top:4px" />
  </div>
  <canvas id="uc-cv" width="360" height="360" style="width:100%;max-width:360px;display:block;margin:0 auto;border-radius:10px;background:#0a1a10"></canvas>
  <div id="uc-vals" style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:8px;margin-top:12px;font-family:monospace;font-size:14px;text-align:center">
    <div style="padding:8px;background:#ff7a5c22;border-radius:8px;border:1px solid #ff7a5c"><div style="font-size:11px;color:#fca5a5">sin \u03B8</div><div id="uc-sin" style="color:#ff7a5c;font-weight:700">0.71</div></div>
    ...
    <div style="padding:8px;background:#3fb04b22;border-radius:8px;border:1px solid #3fb04b"><div style="font-size:11px;color:#8fd770">tan \u03B8</div><div id="uc-tan" style="color:#3fb04b;font-weight:700">1.00</div></div>
  </div>
  <script>
    (function(){
      ...
      window.drawUC=function(){
        ...
        // Axes
        ctx.strokeStyle='#1a2a1f';ctx.lineWidth=1;ctx.beginPath();ctx.moveTo(0,cy);ctx.lineTo(W,cy);ctx.stroke();ctx.beginPath();ctx.moveTo(cx,0);ctx.lineTo(cx,W);ctx.stroke();
        // Circle
        ctx.strokeStyle='#4d5a51';ctx.lineWidth=2;ctx.beginPath();ctx.arc(cx,cy,R,0,Math.PI*2);ctx.stroke();
        var px=cx+R*Math.cos(rad),py=cy-R*Math.sin(rad);
        // Angle arc
        ctx.strokeStyle='#ffd84d';ctx.lineWidth=2;ctx.beginPath();ctx.arc(cx,cy,30,0,-rad,true);ctx.stroke();
        ctx.fillStyle='#ffd84d';ctx.font='12px monospace';ctx.fillText(deg+'\u00B0',cx+34,cy-8);
        // Cos line (horizontal)
        ctx.strokeStyle='#3b82f6';ctx.lineWidth=3;ctx.beginPath();ctx.moveTo(cx,cy);ctx.lineTo(px,cy);ctx.stroke();
        // Sin line (vertical)
        ctx.strokeStyle='#ff7a5c';ctx.lineWidth=3;ctx.beginPath();ctx.moveTo(px,cy);ctx.lineTo(px,py);ctx.stroke();
        // Radius
        ctx.strokeStyle='#e0e0e0';ctx.lineWidth=1.5;ctx.beginPath();ctx.moveTo(cx,cy);ctx.lineTo(px,py);ctx.stroke();
        // Point
        ctx.fillStyle='#ffd84d';ctx.beginPath();ctx.arc(px,py,6,0,Math.PI*2);ctx.fill();
        // Coordinate label
        ...
        // Axis labels
        ctx.fillStyle='#4d5a51';ctx.font='12px monospace';
...
<div id="seq-widget" style="font-family:'Segoe UI',system-ui,sans-serif;max-width:480px;margin:0 auto;padding:20px;background:linear-gradient(135deg,#064e3b,#065f46);border-radius:16px;box-shadow:0 8px 32px rgba(0,0,0,.3);color:#e0e0e0">
  ...
  <div style="display:flex;gap:8px;margin-bottom:12px;flex-wrap:wrap">
    <button onclick="seqAdd('\u2191')" style="padding:10px 16px;border:none;border-radius:10px;background:#3fb04b;color:#fff;font-size:20px;cursor:pointer">\u2191</button>
    <button onclick="seqAdd('\u2193')" style="padding:10px 16px;border:none;border-radius:10px;background:#3fb04b;color:#fff;font-size:20px;cursor:pointer">\u2193</button>
    <button onclick="seqAdd('\u2190')" style="padding:10px 16px;border:none;border-radius:10px;background:#3fb04b;color:#fff;font-size:20px;cursor:pointer">\u2190</button>
    <button onclick="seqAdd('\u2192')" style="padding:10px 16px;border:none;border-radius:10px;background:#3fb04b;color:#fff;font-size:20px;cursor:pointer">\u2192</button>
    <button onclick="seqRun()" style="padding:10px 18px;border:none;border-radius:10px;background:#f5b800;color:#fff;font-weight:700;font-size:14px;cursor:pointer">\u25B6 Run</button>
    <button onclick="seqClear()" style="padding:10px 14px;border:none;border-radius:10px;background:#4d5a51;color:#fff;font-size:14px;cursor:pointer">Clear</button>
  </div>
  ...
  <script>
    (function(){
      ...
      function drawGrid(){
        ...
        // Star at (6,0)
        ctx.fillStyle='#ffd84d';ctx.font='24px serif';ctx.fillText('\u2B50',6*CS+8,0*CS+30);
      }
      function drawRobot(x,y){ctx.fillStyle='#3fb04b';ctx.font='28px serif';ctx.fillText('\uD83E\uDD16',x*CS+6,y*CS+32)}
      function renderCmds(){document.getElementById('seq-cmds').innerHTML=cmds.map(function(c,i){return '<span style="display:inline-block;width:32px;height:32px;line-height:32px;text-align:center;background:#3fb04b33;border-radius:6px;border:1px solid #3fb04b">'+c+'</span>'}).join('')}
      ...
      window.seqRun=function(){
        ...
        var t=setInterval(function(){
          ...
          drawGrid();
          // Trail
          ctx.fillStyle='#3fb04b33';ctx.fillRect(rx*CS,ry*CS,CS,CS);
          drawRobot(rx,ry);
          // Highlight current cmd
          var els=document.getElementById('seq-cmds').children;
          for(var j=0;j<els.length;j++)els[j].style.background=j===i?'#f5b80055':'#3fb04b33';
          i++;
        },400);
      };
...
<div id="rloop-widget" style="font-family:'Segoe UI',system-ui,sans-serif;max-width:480px;margin:0 auto;padding:20px;background:linear-gradient(135deg,#064e3b,#065f46);border-radius:16px;box-shadow:0 8px 32px rgba(0,0,0,.3);color:#e0e0e0">
  ...
  <div style="display:flex;align-items:center;gap:12px;margin-bottom:14px;flex-wrap:wrap">
    ...
    <input id="rl-n" type="range" min="1" max="6" value="3" oninput="document.getElementById('rl-nv').textContent=this.value" style="width:80px;accent-color:#3fb04b" />
    <span id="rl-nv" style="color:#ffd84d;font-family:monospace;font-weight:700">3</span>
    <span style="font-size:13px">times:</span>
    <select id="rl-cmd" style="padding:6px;border-radius:8px;background:#052e16;color:#e0e0e0;border:1px solid #3fb04b;font-size:14px">
      <option value="\u2192">Move Right \u2192</option>
      <option value="\u2191">Move Up \u2191</option>
      <option value="\u2193">Move Down \u2193</option>
    </select>
    <button onclick="unrollLoop()" style="padding:8px 18px;border:none;border-radius:10px;background:#f5b800;color:#fff;font-weight:700;cursor:pointer;font-size:14px">Unroll</button>
  </div>
  <div style="display:flex;gap:16px;flex-wrap:wrap">
    <div style="flex:1;min-width:140px">
      <div style="font-size:12px;color:#9aa39d;margin-bottom:4px">Loop (compact):</div>
      <div id="rl-compact" style="padding:10px;background:#052e16;border-radius:10px;border:2px solid #3fb04b;font-family:monospace;font-size:13px;text-align:center"></div>
    </div>
    <div style="font-size:28px;line-height:80px;color:#ffd84d">\u27A1</div>
    <div style="flex:1;min-width:140px">
      <div style="font-size:12px;color:#9aa39d;margin-bottom:4px">Unrolled (expanded):</div>
      <div id="rl-expanded" style="padding:10px;background:#052e16;border-radius:10px;border:2px dashed #f5b800;font-family:monospace;font-size:13px;min-height:40px"></div>
    </div>
  </div>
  <script>
    (function(){
      window.unrollLoop=function(){
        ...
        document.getElementById('rl-compact').innerHTML='<div style="color:#3fb04b;font-size:15px">repeat '+n+' times {</div><div style="padding:6px 0;font-size:16px">'+cmd+'</div><div style="color:#3fb04b;font-size:15px">}</div>';
        var expanded='';
        var i=0;
        document.getElementById('rl-expanded').innerHTML='';
        var timer=setInterval(function(){
          if(i>=n){clearInterval(timer);return}
          expanded+='<div style="padding:4px 0;animation:fadeIn .3s ease;color:#ffd84d"><span style="color:#9aa39d;font-size:11px">#'+(i+1)+'</span> '+cmd+' '+cmdText+'</div>';
...
<div id="cond-widget" style="font-family:'Segoe UI',system-ui,sans-serif;max-width:480px;margin:0 auto;padding:20px;background:linear-gradient(135deg,#064e3b,#065f46);border-radius:16px;box-shadow:0 8px 32px rgba(0,0,0,.3);color:#e0e0e0">
  ...
  <div style="text-align:center;margin-bottom:14px">
    <span style="font-size:14px">Is there a <strong style="color:#ffd84d">wall ahead</strong>?</span>
    <div style="margin-top:8px;display:flex;justify-content:center;gap:12px">
      <button id="cond-yes" onclick="condSet(true)" style="padding:10px 28px;border:2px solid #3fb04b;border-radius:10px;background:transparent;color:#3fb04b;font-weight:700;cursor:pointer;font-size:14px;transition:all .2s">Yes \uD83E\uDDF1</button>
  ...
  <svg viewBox="0 0 340 220" style="width:100%;max-width:340px;display:block;margin:0 auto">
    ...
    <!-- Diamond -->
    <polygon id="cond-diamond" points="170,55 240,90 170,125 100,90" fill="#052e16" stroke="#ffd84d" stroke-width="2"/>
    <text x="170" y="95" text-anchor="middle" fill="#ffd84d" font-size="11" font-family="monospace">wall ahead?</text>
    <!-- Yes branch -->
    ...
    <text x="65" y="83" fill="#3fb04b" font-size="11" font-family="monospace">Yes</text>
    <rect id="cond-turn" x="5" y="155" width="90" height="40" rx="10" fill="#052e16" stroke="#3fb04b" stroke-width="2"/>
    <text x="50" y="178" text-anchor="middle" fill="#3fb04b" font-size="12" font-family="monospace">Turn right</text>
  ...
  <script>
    (function(){
      window.condSet=function(wall){
        document.getElementById('cond-yes').style.background=wall?'#3fb04b33':'transparent';
        ...
        document.getElementById('cond-result').innerHTML=wall
          ?'\uD83E\uDD16 <span style="color:#3fb04b">Wall detected! Turning right...</span>'
...
<div id="prog-widget" style="font-family:'Segoe UI',system-ui,sans-serif;max-width:480px;margin:0 auto;padding:20px;background:linear-gradient(135deg,#1e1b4b,#312e81);border-radius:16px;box-shadow:0 8px 32px rgba(0,0,0,.3);color:#e0e0e0">
  ...
  <div style="margin-top:14px;text-align:center">
    <button onclick="progReset()" style="padding:8px 20px;border:none;border-radius:10px;background:#0a8754;color:#fff;font-weight:600;cursor:pointer;font-size:13px">Reset Progress</button>
  </div>
  <script>
    (function(){
      var topics=[
        ...
        {name:'Loops',icon:'\uD83D\uDD01',pct:0,color:'#3fb04b'},
        {name:'Functions',icon:'\u2699\uFE0F',pct:0,color:'#f5b800'},
        {name:'Lists',icon:'\uD83D\uDCCB',pct:0,color:'#ff7a5c'}
      ];
      function render(){
        var html='';
...
<div id="flash-widget" style="font-family:'Segoe UI',system-ui,sans-serif;max-width:420px;margin:0 auto;padding:20px;background:linear-gradient(135deg,#1e1b4b,#312e81);border-radius:16px;box-shadow:0 8px 32px rgba(0,0,0,.3);color:#e0e0e0">
  ...
  <div id="flash-card" onclick="flipCard()" style="min-height:180px;background:#2e1065;border-radius:16px;cursor:pointer;display:flex;align-items:center;justify-content:center;text-align:center;padding:24px;border:2px solid #7c3aed;transition:transform .4s,box-shadow .4s;position:relative;perspective:600px;user-select:none" onmouseenter="this.style.boxShadow='0 0 24px #7c3aed66'" onmouseleave="this.style.boxShadow='none'">
    ...
    <div style="position:absolute;bottom:10px;right:14px;font-size:11px;color:#0a8754">click to flip</div>
  </div>
  <div style="display:flex;justify-content:space-between;align-items:center;margin-top:14px">
    ...
    <span id="flash-counter" style="font-family:monospace;font-size:13px;color:#9aa39d"></span>
    ...
    (function(){
      var cards=[
        {front:'<div style="font-size:36px;font-family:serif;color:#f0abfc">a\u00B2 + b\u00B2 = c\u00B2</div><div style="font-size:13px;color:#c084fc;margin-top:8px">Pythagorean Theorem</div>',
         back:'<div style="font-size:15px;color:#e0e0e0;line-height:1.6">In a right triangle, the square of the hypotenuse equals the sum of squares of the other two sides.<br/><br/><span style="color:#ffd84d">Use when:</span> Finding missing side lengths in right triangles</div>'},
        {front:'<div style="font-size:32px;font-family:serif;color:#f0abfc">m = (y\u2082 - y\u2081) / (x\u2082 - x\u2081)</div><div style="font-size:13px;color:#c084fc;margin-top:8px">Slope Formula</div>',
         back:'<div style="font-size:15px;color:#e0e0e0;line-height:1.6">Slope measures steepness: rise over run between two points.<br/><br/><span style="color:#ffd84d">Positive:</span> goes up \u2197<br/><span style="color:#ffd84d">Negative:</span> goes down \u2198<br/><span style="color:#ffd84d">Zero:</span> horizontal \u2192</div>'},
        {front:'<div style="font-size:30px;font-family:serif;color:#f0abfc">x = (-b \u00B1 \u221A(b\u00B2-4ac)) / 2a</div><div style="font-size:13px;color:#c084fc;margin-top:8px">Quadratic Formula</div>',
         back:'<div style="font-size:15px;color:#e0e0e0;line-height:1.6">Solves any quadratic equation ax\u00B2+bx+c=0.<br/><br/><span style="color:#ffd84d">Discriminant b\u00B2-4ac:</span><br/>> 0 \u2192 two real roots<br/>= 0 \u2192 one root<br/>< 0 \u2192 no real roots</div>'},
        {front:'<div style="font-size:36px;font-family:serif;color:#f0abfc">A = \u03C0r\u00B2</div><div style="font-size:13px;color:#c084fc;margin-top:8px">Area of a Circle</div>',
         back:'<div style="font-size:15px;color:#e0e0e0;line-height:1.6">The area enclosed by a circle with radius r.<br/><br/>\u03C0 \u2248 3.14159<br/><span style="color:#ffd84d">Example:</span> r=5 \u2192 A=25\u03C0 \u2248 78.54</div>'},
        {front:'<div style="font-size:34px;font-family:serif;color:#f0abfc">d = \u221A((x\u2082-x\u2081)\u00B2+(y\u2082-y\u2081)\u00B2)</div><div style="font-size:13px;color:#c084fc;margin-top:8px">Distance Formula</div>',
         back:'<div style="font-size:15px;color:#e0e0e0;line-height:1.6">Distance between two points in a coordinate plane.<br/><br/>Derived from the Pythagorean theorem applied to horizontal and vertical differences.<br/><span style="color:#ffd84d">Always positive!</span></div>'}
      ];
