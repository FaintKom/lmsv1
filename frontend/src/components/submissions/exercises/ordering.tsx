          ...
          >
            ...
            <div className="flex gap-1">
              <button
                ...
                className="rounded-lg p-2 text-slate-400 transition-colors hover:bg-slate-100 hover:text-slate-600 disabled:opacity-30 dark:text-slate-500 dark:hover:bg-white/10 dark:hover:text-slate-300"
              >
