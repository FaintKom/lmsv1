...
export default function OrderingExercise({ items, onSubmit }: OrderingExerciseProps) {
 ...
 <span className="flex-1 text-sm font-medium text-text ">{item}</span>
 ...
 className="mt-6 w-full rounded-lg bg-primary px-4 py-2.5 text-sm font-semibold text-primary-fg transition-colors hover:bg-primary-hover "
 >
 Submit Answer
 </button>
 </div>
