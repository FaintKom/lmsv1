...
export default function AuthLayout({
  ...
  return (
    <div className="flex min-h-screen">
      ...
      {/* Left side - branding */}
      <div className="hidden w-1/2 bg-gradient-to-br from-green-600 via-green-700 to-green-800 lg:flex lg:flex-col lg:items-center lg:justify-center">
      ...
      {/* Right side - form */}
      <div className="flex w-full items-center justify-center bg-ink-50 px-6 lg:w-1/2 dark:bg-[#1E1E1E]">
