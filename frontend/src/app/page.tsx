      ...
      <main>
        ...
        <section className="relative overflow-hidden">
          ...
          <div className="mx-auto max-w-4xl px-6 pb-4 pt-8 text-center md:pt-10">
            ...
            <p className="mt-3 text-sm text-text-subtle">{t("landing.hero.demoHint")}</p>
          </div>
        </section>
        ...
        <section className="border-t border-border bg-surface-2/50 py-16">
          <div className="mx-auto grid max-w-5xl items-center gap-10 px-6 md:grid-cols-2">
            ...
            <div className="overflow-hidden rounded-xl border border-border-strong bg-surface shadow-xl">
              ...
              {/* Column headers, not grey filler bars: the earlier version read
                  as a skeleton that had failed to load. */}
              <div className="flex items-center justify-between px-4 pt-4 text-3xs uppercase tracking-wide text-text-subtle">
                <span>{t("landing.live.colStudent")}</span>
                <span>{t("landing.live.colStatus")}</span>
              </div>
                ...
                {roster.map((row) => (
                  ...
                  >
                    <span className="flex items-center gap-2.5 text-sm font-medium text-text">
                      ...
                      {t("landing.live.rosterRow")} {row.initial}
                    </span>
                    <span
          ...
          <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
            ...
            <div className="flex flex-wrap justify-center gap-x-5 gap-y-2 text-sm text-text-subtle">
              {[
                ...
                { href: "/refund", label: t("landing.footerRefund") },
