      ...
      <main>
        ...
        <section className="relative overflow-hidden">
          ...
          <div className="mx-auto max-w-6xl px-6 pb-20 pt-20 text-center md:pt-28">
            ...
            <h1 className="mb-6 text-4xl font-extrabold leading-tight tracking-tight text-ink-900 md:text-6xl">
              Teach smarter with
              <br />
              <span className="gl-highlight">interactive learning</span>
            </h1>
            <p className="mx-auto mb-10 max-w-2xl text-lg leading-relaxed text-ink-500">
        ...
        <section className="border-t border-ink-100 bg-ink-50/50 py-20">
          <div className="mx-auto max-w-6xl px-6">
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
              <div className="group rounded-2xl border border-ink-200/60 bg-white p-8 transition-all hover:border-green-200 hover:shadow-lg hover:shadow-green-50">
              ...
              <div className="group rounded-2xl border border-ink-200/60 bg-white p-8 transition-all hover:border-sun-100 hover:shadow-lg hover:shadow-sun-50">
                <div className="mb-5 inline-flex rounded-2xl bg-sun-50 p-3.5">
                  <Gamepad2 className="h-6 w-6 text-sun-500" />
                </div>
                <h3 className="mb-2 text-lg font-semibold text-ink-900">
                  Game-Based Learning
                </h3>
              ...
              <div className="group rounded-2xl border border-ink-200/60 bg-white p-8 transition-all hover:border-coral-300 hover:shadow-lg hover:shadow-coral-50">
                <div className="mb-5 inline-flex rounded-2xl bg-coral-50 p-3.5">
              ...
              <div className="group rounded-2xl border border-ink-200/60 bg-white p-8 transition-all hover:border-sky-200 hover:shadow-lg hover:shadow-sky-50">
          ...
          <div className="mx-auto max-w-6xl px-6">
            <div className="grid grid-cols-1 gap-12 md:grid-cols-3">
              <div className="text-center">
                <div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-sun-50">
                  <Globe className="h-6 w-6 text-sun-500" />
                </div>
            ...
            <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
              {[
                ...
                <div key={m.label} className="text-center">
                  ...
                  <p className="mt-2 text-sm font-semibold text-ink-900">{m.label}</p>
                  <p className="mt-1 text-xs text-ink-400">{m.sub}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="border-t border-ink-100 bg-ink-50/50 py-20">
          <div className="mx-auto max-w-6xl px-6">
            <div className="mb-12 text-center">
              <h2 className="mb-3 text-3xl font-bold text-ink-900">See what you get</h2>
              <p className="text-ink-500">A complete teaching toolkit, ready out of the box</p>
            </div>
            <div className="grid gap-6 md:grid-cols-2">
              <div className="group rounded-2xl border border-ink-200/60 bg-white p-8 transition-all hover:shadow-lg">
                <div className="mb-4 flex items-center gap-3">
                  <div className="rounded-xl bg-green-50 p-3"><Monitor className="h-6 w-6 text-green-600" /></div>
                  <h3 className="text-lg font-semibold text-ink-900">Student Dashboard</h3>
                </div>
              ...
              <div className="group rounded-2xl border border-ink-200/60 bg-white p-8 transition-all hover:shadow-lg">
                <div className="mb-4 flex items-center gap-3">
                  <div className="rounded-xl bg-green-50 p-3"><Layout className="h-6 w-6 text-green-600" /></div>
                  <h3 className="text-lg font-semibold text-ink-900">Teacher Admin Panel</h3>
                </div>
                <p className="mb-4 text-sm leading-relaxed text-ink-500">
              ...
              <div className="group rounded-2xl border border-ink-200/60 bg-white p-8 transition-all hover:shadow-lg">
                <div className="mb-4 flex items-center gap-3">
                  <div className="rounded-xl bg-sun-50 p-3"><Code className="h-6 w-6 text-sun-500" /></div>
                  <h3 className="text-lg font-semibold text-ink-900">Code Sandbox</h3>
                </div>
                <p className="mb-4 text-sm leading-relaxed text-ink-500">
                ...
                <div className="flex flex-wrap gap-2">
                  {["37 languages", "Auto-grading", "Test cases", "Live preview", "HTML/CSS/JS editor"].map((f) => (
                    <span key={f} className="inline-flex items-center gap-1 rounded-full bg-sun-50 px-3 py-1 text-xs font-medium text-sun-700">
                      <CheckCircle className="h-3 w-3" /> {f}
                    </span>
                  ))}
                </div>
              ...
              <div className="group rounded-2xl border border-ink-200/60 bg-white p-8 transition-all hover:shadow-lg">
                <div className="mb-4 flex items-center gap-3">
                  ...
                  <h3 className="text-lg font-semibold text-ink-900">SAT Math Simulator</h3>
                </div>
                <p className="mb-4 text-sm leading-relaxed text-ink-500">
        ...
        <section className="py-20">
          <div className="mx-auto max-w-6xl px-6">
            <div className="mb-12 text-center">
              <h2 className="mb-3 text-3xl font-bold text-ink-900">Built for everyone who teaches</h2>
              <p className="text-ink-500">Whether you run a school, teach online, or tutor small groups</p>
            </div>
            <div className="grid gap-8 md:grid-cols-3">
              <div className="rounded-2xl border border-green-200/60 bg-gradient-to-b from-green-50 to-white p-8">
                ...
                <h3 className="mb-2 text-lg font-bold text-ink-900">Schools</h3>
                <p className="mb-4 text-sm leading-relaxed text-ink-500">
              ...
              <div className="rounded-2xl border border-green-200/60 bg-gradient-to-b from-green-50 to-white p-8">
                ...
                <h3 className="mb-2 text-lg font-bold text-ink-900">Online Schools</h3>
                <p className="mb-4 text-sm leading-relaxed text-ink-500">
                  Launch your online education business. Create courses, sell access,
                  and scale to hundreds of students with automated tools.
                </p>
                <ul className="space-y-2 text-sm text-ink-700">
                  <li className="flex items-center gap-2"><CheckCircle className="h-4 w-4 text-green-500 shrink-0" /> Unlimited course creation</li>
                  <li className="flex items-center gap-2"><CheckCircle className="h-4 w-4 text-green-500 shrink-0" /> Student analytics & progress</li>
                  <li className="flex items-center gap-2"><CheckCircle className="h-4 w-4 text-green-500 shrink-0" /> Certificates & achievements</li>
                  <li className="flex items-center gap-2"><CheckCircle className="h-4 w-4 text-green-500 shrink-0" /> AI tutor for 24/7 support</li>
                </ul>
              </div>

              <div className="rounded-2xl border border-sun-100/60 bg-gradient-to-b from-sun-50 to-white p-8">
                <div className="mb-5 inline-flex rounded-2xl bg-sun-100 p-3.5">
                  <UserCheck className="h-7 w-7 text-sun-500" />
                </div>
                <h3 className="mb-2 text-lg font-bold text-ink-900">Tutors</h3>
                <p className="mb-4 text-sm leading-relaxed text-ink-500">
                  Perfect for private tutors and small groups. Interactive lessons,
                  SAT prep, and coding exercises — all in one platform.
                </p>
                <ul className="space-y-2 text-sm text-ink-700">
                  <li className="flex items-center gap-2"><CheckCircle className="h-4 w-4 text-sun-500 shrink-0" /> Free plan for up to 20 students</li>
                  <li className="flex items-center gap-2"><CheckCircle className="h-4 w-4 text-sun-500 shrink-0" /> SAT Math adaptive simulator</li>
                  <li className="flex items-center gap-2"><CheckCircle className="h-4 w-4 text-sun-500 shrink-0" /> Live lessons & calendar</li>
                  <li className="flex items-center gap-2"><CheckCircle className="h-4 w-4 text-sun-500 shrink-0" /> Quick setup, no tech needed</li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <section className="border-t border-ink-100 bg-ink-50/50 py-20">
          <div className="mx-auto max-w-3xl px-6">
            <div className="mb-12 text-center">
              <h2 className="mb-3 text-3xl font-bold text-ink-900">Frequently asked questions</h2>
              <p className="text-ink-500">Everything you need to know before getting started</p>
            </div>
            <div className="space-y-3">
              {[
                ...
                <details key={item.q} className="group rounded-xl border border-ink-200 bg-white">
                  <summary className="flex cursor-pointer items-center justify-between px-6 py-4 text-sm font-semibold text-ink-900 [&::-webkit-details-marker]:hidden">
                    {item.q}
                    <ChevronDown className="h-4 w-4 text-ink-400 transition-transform group-open:rotate-180" />
                  </summary>
                  <div className="px-6 pb-4 text-sm leading-relaxed text-ink-500">
                    {item.a}
                  </div>
                </details>
              ))}
        ...
        {/* CTA */}
        <section className="border-t border-ink-100 bg-gradient-to-b from-green-50/50 to-white py-20">
          <div className="mx-auto max-w-2xl px-6 text-center">
            <h2 className="mb-4 text-3xl font-bold text-ink-900">
              Ready to <span className="gl-highlight">get started?</span>
            </h2>
        ...
        <div className="mx-auto max-w-6xl px-6">
          <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
            ...
            <div className="flex gap-6 text-sm text-ink-400">
              ...
              <Link href="/cookies" className="hover:text-ink-700">Cookies</Link>
            </div>
          </div>
        </div>
      </footer>
