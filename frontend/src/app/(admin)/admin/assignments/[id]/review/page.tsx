                      ...
                      {sub.original_filename && (
                        <div className="mb-4">
                          ...
                          <a
                            ...
                            className="inline-flex items-center gap-1.5 rounded-lg bg-slate-50 px-3 py-2 text-sm text-green-600 hover:bg-slate-100 dark:bg-white/5 dark:text-green-400 dark:hover:bg-white/10"
                            target="_blank"
                        ...
                        <div className="flex flex-col gap-3 sm:flex-row sm:items-end">
                          <div className="flex-shrink-0">
                            ...
                            <input
                              ...
                              className="w-24 rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm text-slate-900 focus:border-green-500 focus:outline-none dark:border-white/10 dark:bg-[#2C2C2C] dark:text-slate-100"
                            />
                          </div>
                          <div className="flex-1">
