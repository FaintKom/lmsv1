...
export default function SATPracticePage() {
 ...
 {/* Mini test */}
 <Card className="group cursor-pointer transition hover:shadow-lg hover:border-primary "
 ...
 {/* Full adaptive test */}
 <Card className="group cursor-pointer transition hover:shadow-lg hover:border-primary ring-2 ring-green-200 "
 ...
 className="flex items-center gap-3 rounded-lg border border-border-strong bg-surface-2 px-4 py-3 text-left transition hover:border-primary hover:shadow-sm "
 >
